...
export class CreateSuperUserRolePermission extends BaseGraaspError {
  constructor() {
    super({ code: 'GSUERR018', statusCode: 403, message: 'Only SuperUsers can assign a permission to the SuperUser role' });
  }
}

export class SUPermissionNotAssignable extends BaseGraaspError {
  constructor() {
    super({ code: 'GSUERR019', statusCode: 403, message: 'SuperUser permission cannot be assigned to any Role' });
  }
}

export class SUPermissionNotRemovable extends BaseGraaspError {
  constructor() {
    super({ code: 'GSUERR020', statusCode: 403, message: 'SuperUser permission cannot be removed from role' });
  }
}

export class SURoleDelete extends BaseGraaspError {
  constructor() {
    super({ code: 'GSUERR021', statusCode: 403, message: 'SuperUser role cannot be deleted' });
  }
}

export class SURoleNotAssignable extends BaseGraaspError {
  constructor() {
    super({ code: 'GSUERR022', statusCode: 403, message: 'Only SuperUser can assign SuperUser Privilege' });
  }
}

export class SURoleNotRemovable extends BaseGraaspError {
  constructor() {
    super({ code: 'GSUERR023', statusCode: 403, message: 'SuperUser privilege cannot be removed' });
  }
}

export class SURoleUpdate extends BaseGraaspError {
  constructor() {
    super({ code: 'GSUERR023', statusCode: 403, message: 'Only SuperUsers can edit SuperUser Role Description' });
  }
}
